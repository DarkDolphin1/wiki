...
| `TARGET_INCLUDE_GRAMOPHONE`      |     false     |     true/false      | define if the build will include [Gramophone app](https://github.com/FoedusProgramme/Gramophone).Gramphone is music player with media3 and material design    |
...
| `PERF_ANIM_OVERRIDE`             |     false     |     true/false      |                                                        Fixes Forward Animation lag on MTK devices.                                                            |
